...
public class ContarDescendente extends ActionBarActivity {
	ImageView idImagen/*, idNumero*/;
	int poss, contador = 9, contador2, errores, numeroPreguntas;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_contar_descendente);

		idImagen = (ImageView) findViewById(R.id.imageView_imagen);
		idImagen.setImageResource(R.drawable.escaleraroja10);
	...
	public void prueba(View view) {
		if(eJuego == false){
			if(view == button1){
				...
				textView3.setText("¿Qué número es el que sigue?");
	...
	private void nexPreviuSong(View v) {
		...
		case 0:
			contador = 0;
			idImagen.setImageResource(R.drawable.escaleraroja1);
			//idNumero.setImageResource(R.drawable.numero1);
			try {
				mpl.reset();
		...
		case 1:
			contador = 1;
			idImagen.setImageResource(R.drawable.escaleraroja2);
			//idNumero.setImageResource(R.drawable.numero2);
			try {
				mpl.reset();
		...
		case 2:
			contador = 2;
			idImagen.setImageResource(R.drawable.escaleraroja3);
			//idNumero.setImageResource(R.drawable.numero3);
			try {
				mpl.reset();
		...
		case 3:
			contador = 3;
			idImagen.setImageResource(R.drawable.escaleraroja4);
			//idNumero.setImageResource(R.drawable.numero4);
			try {
				mpl.reset();
		...
		case 4:
			contador = 4;
			idImagen.setImageResource(R.drawable.escaleraroja5);
			//idNumero.setImageResource(R.drawable.numero5);
			try {
				mpl.reset();
		...
		case 5:
			contador = 5;
			idImagen.setImageResource(R.drawable.escaleraroja6);
			//idNumero.setImageResource(R.drawable.numero6);
			try {
				mpl.reset();
		...
		case 6:
			contador = 6;
			idImagen.setImageResource(R.drawable.escaleraroja7);
			//idNumero.setImageResource(R.drawable.numero7);
			try {
				mpl.reset();
		...
		case 7:
			contador = 7;
			idImagen.setImageResource(R.drawable.escaleraroja8);
			//idNumero.setImageResource(R.drawable.numero8);
			try {
				mpl.reset();
		...
		case 8:
			contador = 8;
			idImagen.setImageResource(R.drawable.escaleraroja9);
			//idNumero.setImageResource(R.drawable.numero9);
			try {
				mpl.reset();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.contar_descendente, menu);
		return true;
	}
