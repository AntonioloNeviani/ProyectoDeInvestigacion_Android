...
public class Objetos extends ActionBarActivity {
	...
	private void eJuegoN() {
		...
		case 0:
			contador = 0;
			idImagen.setImageResource(R.drawable.ico_tringulo);
			break;
		case 1:
			contador = 1;
			idImagen.setImageResource(R.drawable.caritas);
			break;
		case 2:
			contador = 2;
			idImagen.setImageResource(R.drawable.flechas);
			break;
		case 3:
			contador = 3;
			idImagen.setImageResource(R.drawable.soles);
			break;
		case 4:
			contador = 4;
			idImagen.setImageResource(R.drawable.cubos);
			break;
		case 5:
			contador = 5;
			idImagen.setImageResource(R.drawable.tringulos);
			break;
		case 6:
			contador = 6;
			idImagen.setImageResource(R.drawable.cuboschuecos);
			break;
		case 7:
			contador = 7;
			idImagen.setImageResource(R.drawable.hexagono);
			break;
		case 8:
			contador = 8;
			idImagen.setImageResource(R.drawable.circulos);
			break;
		case 9:
			contador = 9;
			idImagen.setImageResource(R.drawable.cubosazul);
			break;
		}
	}
