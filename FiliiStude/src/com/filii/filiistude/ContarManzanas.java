...
public class ContarManzanas extends ActionBarActivity {
	...
	TextView textView3, textViewInferior;
	MediaPlayer mpl;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_contar_manzanas);
	...
	public void prueba(View view) {
		if(eJuego == false){
			if(view == button1){
				...
				textView3.setText("¿Cuántas manzanas hay?");
	...
	private void nexPreviuSong(View v) {
		...
		case 1:
			contador = 1;
			idImagen.setImageResource(R.drawable.manzana2);
			idNumero.setImageResource(R.drawable.numero2);
			try {
				mpl.reset();
		...
		case 2:
			contador = 2;
			idImagen.setImageResource(R.drawable.manzana3);
			idNumero.setImageResource(R.drawable.numero3);
			try {
				mpl.reset();
		...
		case 3:
			contador = 3;
			idImagen.setImageResource(R.drawable.manzana4);
			idNumero.setImageResource(R.drawable.numero4);
			try {
				mpl.reset();
		...
		case 4:
			contador = 4;
			idImagen.setImageResource(R.drawable.manzana5);
			idNumero.setImageResource(R.drawable.numero5);
			try {
				mpl.reset();
		...
		case 5:
			contador = 5;
			idImagen.setImageResource(R.drawable.manzana6);
			idNumero.setImageResource(R.drawable.numero6);
			try {
				mpl.reset();
		...
		case 6:
			contador = 6;
			idImagen.setImageResource(R.drawable.manzana7);
			idNumero.setImageResource(R.drawable.numero7);
			try {
				mpl.reset();
		...
		case 7:
			contador = 7;
			idImagen.setImageResource(R.drawable.manzana8);
			idNumero.setImageResource(R.drawable.numero8);
			try {
				mpl.reset();
		...
		case 8:
			contador = 8;
			idImagen.setImageResource(R.drawable.manzana9);
			idNumero.setImageResource(R.drawable.numero9);
			try {
				mpl.reset();
		...
		case 9:
			contador = 9;
			idImagen.setImageResource(R.drawable.manzana10);
			idNumero.setImageResource(R.drawable.numero10);
			try {
				mpl.reset();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.contar_manzanas, menu);
		return true;
	}
